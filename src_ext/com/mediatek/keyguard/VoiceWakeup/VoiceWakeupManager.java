...
public class VoiceWakeupManager implements OnDismissAction {
    ...
    private String getLaunchAppNameFromSettings(int commandId, boolean calledFromTest) {
        ...
        /*else {
            appName = MtkSettingsExt.System.getVoiceCommandValue(mContext.getContentResolver(),
    ...
    public void notifySecurityModeChange(KeyguardSecurityModel.SecurityMode currentMode,
        ...
        if (mPM.isScreenOn() && mIsDismissAndLaunchApp) {
            if (nextMode == KeyguardSecurityModel.SecurityMode.AntiTheft ||
                    nextMode == KeyguardSecurityModel.SecurityMode.AlarmBoot) {
    ...
    // === For AT test === begin
    public IVoiceCommandManagerService getVoiceCommandManagerService() {
        return mVCmdMgrService;
    }
