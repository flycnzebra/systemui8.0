...
public class VolumeDialogImpl implements VolumeDialog, TunerService.Tunable {
    ...
    private void updateVolumeRowH(VolumeRow row) {
        ...
        if (atcEnhancementSupport()) {
            ...
            zenMuted = isZenAlarms ? (isRingStream || isSystemStream)
                    : isZenNone ? (isRingStream || isSystemStream || isAlarmStream || isMusicStream || isGISStream || isAuxInStream)
                    : false;
        } else {
            zenMuted = isZenAlarms ? (isRingStream || isSystemStream)
