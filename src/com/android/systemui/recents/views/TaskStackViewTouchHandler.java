        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN: {
                ...
                if(android.os.SystemProperties.getBoolean("ro.atc.aosp_enhancement", false)) {
                    if(mVelocityTracker != null) {//atc add to avoid nullpointer exception
                        mVelocityTracker.addMovement(ev);
                    }
                } else {
                    mVelocityTracker.addMovement(ev);
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (activePointerIndex < 0) {
                    Log.w("TaskStackViewTouchHandler", "findPointerIndex failed: "
                          + activePointerIndex);
            ...
            case MotionEvent.ACTION_UP: {
                //atc add to solve nullpointer exception
                if(android.os.SystemProperties.getBoolean("ro.atc.aosp_enhancement", false)) {
                    if(mVelocityTracker == null) {
                        mActivePointerId = INACTIVE_POINTER_ID;
                        mIsScrolling = false;
