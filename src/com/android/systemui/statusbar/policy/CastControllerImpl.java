...
public class CastControllerImpl implements CastController {
    ...
    private void updateWfdSupportState() {
        WifiDisplayStatus status = mDisplayManager.getWifiDisplayStatus();
        mWfdSupport = status != null && status.getFeatureState()
                != WifiDisplayStatus.FEATURE_STATE_UNAVAILABLE;
        if (DEBUG) Log.d(TAG, "updateWfdSupportState : " + mWfdSupport);
    }
    /// @}
    ...
    private void fireOnWfdStatusChanged(Callback callback) {
        callback.onWfdStatusChanged(mDisplayManager.getWifiDisplayStatus(),
                /** mDisplayManager.isSinkEnabled() **/ false);
    }
    ...
    private boolean atcEnhancementSupport() {
