   ...
   /* M : Override onDestroy method to unregister configuration changed
    ...
    class DrawableEngine extends Engine {
        ...
        public void onCreate(SurfaceHolder surfaceHolder) {
            ...
            // For tablet, after boot , loading the wallpaper bitmap before updateSurfaceSize
            if (mIstablet&& (mBackgroundWidth <= 0 || mBackgroundHeight <= 0)) {
                // Need to load the image to get dimensions
                mWallpaperManager.forgetLoadedWallpaper();
                loadWallpaper(false,false);
            }
            ...
            try {
                ...
                if (mIsHwAccelerated) {
                    ...
                    if (FIXED_SIZED_SURFACE) {
                        ...
                        //don't unload on tablet ,for faster rotation
                        if (!mIstablet) {
