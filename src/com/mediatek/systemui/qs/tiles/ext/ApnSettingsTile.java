...
public class ApnSettingsTile extends QSTileImpl<BooleanState> {
    ...
    public void handleSetListening(boolean listening) {
        ...
        if (listening) {
            ...
            mIntentFilter.addAction(MtkTelephonyIntents.ACTION_EF_CSP_CONTENT_NOTIFY);
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
                ...
                updateState();
            } else if (action.equals(MtkTelephonyIntents.ACTION_EF_CSP_CONTENT_NOTIFY)
                    || action.equals(MtkTelephonyIntents.ACTION_MSIM_MODE_CHANGED)
