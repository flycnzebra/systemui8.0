 ...
 */
public class SimDataConnectionTile extends QSTileImpl<BooleanState> {
     ...
     */
    public SimDataConnectionTile(QSHost host) {
        super(host);
        init();
        handleStale();
    }
    ...
    private class SimDataSwitchStateMachine {
        ...
        public void onActualStateChange(Context context, Intent intent) {
            ...
            if (SubscriptionManager.getSlotIndex(dataConnectionId) == PhoneConstants.SIM_ID_1) {
                sim1Conn = true;
                sim2Conn = false;
            } else if (SubscriptionManager.getSlotIndex(dataConnectionId)
        ...
        private void handleDataConnectionChange(int newSlot) {
            ...
            if (SubscriptionManager.getSlotIndex(SubscriptionManager.getDefaultDataSubscriptionId())
                    != newSlot) {
